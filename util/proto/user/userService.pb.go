...
var file_user_userService_proto_rawDesc = []byte{
	...
	0x64, 0x32, 0xc5, 0x09, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	...
	0x72, 0x69, 0x65, 0x6e, 0x63, 0x65, 0x49, 0x64, 0x7d, 0x42, 0x38, 0x5a, 0x36, 0x67, 0x69, 0x74,
...
var file_user_userService_proto_msgTypes = make([]protoimpl.MessageInfo, 20)
...
var file_user_userService_proto_depIdxs = []int32{
	...
	2,  // 8: user.UserService.GetRequest:input_type -> user.UserIdRequest
	4,  // 9: user.UserService.GetAllRequest:input_type -> user.EmptyRequest
	6,  // 10: user.UserService.PostRequest:input_type -> user.UserRequest
	6,  // 11: user.UserService.PostAdminRequest:input_type -> user.UserRequest
	6,  // 12: user.UserService.UpdateRequest:input_type -> user.UserRequest
	2,  // 13: user.UserService.DeleteRequest:input_type -> user.UserIdRequest
	10, // 14: user.UserService.SearchUsersRequest:input_type -> user.SearchRequest
	8,  // 15: user.UserService.LoginRequest:input_type -> user.CredentialsRequest
	11, // 16: user.UserService.IsUserAuthenticated:input_type -> user.AuthRequest
	13, // 17: user.UserService.UpdatePasswordRequest:input_type -> user.NewPasswordRequest
	15, // 18: user.UserService.GetAllUsersExperienceRequest:input_type -> user.ExperienceRequest
	17, // 19: user.UserService.PostExperienceRequest:input_type -> user.NewExperienceRequest
	19, // 20: user.UserService.DeleteExperienceRequest:input_type -> user.DeleteUsersExperienceRequest
	3,  // 21: user.UserService.GetRequest:output_type -> user.GetResponse
	5,  // 22: user.UserService.GetAllRequest:output_type -> user.UsersResponse
	3,  // 23: user.UserService.PostRequest:output_type -> user.GetResponse
	3,  // 24: user.UserService.PostAdminRequest:output_type -> user.GetResponse
	3,  // 25: user.UserService.UpdateRequest:output_type -> user.GetResponse
	4,  // 26: user.UserService.DeleteRequest:output_type -> user.EmptyRequest
	5,  // 27: user.UserService.SearchUsersRequest:output_type -> user.UsersResponse
	9,  // 28: user.UserService.LoginRequest:output_type -> user.LoginResponse
	12, // 29: user.UserService.IsUserAuthenticated:output_type -> user.AuthResponse
	3,  // 30: user.UserService.UpdatePasswordRequest:output_type -> user.GetResponse
	16, // 31: user.UserService.GetAllUsersExperienceRequest:output_type -> user.ExperienceResponse
	18, // 32: user.UserService.PostExperienceRequest:output_type -> user.NewExperienceResponse
	4,  // 33: user.UserService.DeleteExperienceRequest:output_type -> user.EmptyRequest
