...
var file_user_userService_proto_rawDesc = []byte{
	...
	0x61, 0x67, 0x65, 0x32, 0xa5, 0x14, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76,
	...
	0x65, 0x6e, 0x2f, 0x7b, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x7d, 0x42, 0x38, 0x5a, 0x36, 0x67,
...
var file_user_userService_proto_msgTypes = make([]protoimpl.MessageInfo, 33)
...
var file_user_userService_proto_depIdxs = []int32{
	...
	31, // 19: user.UserService.ConfirmRegistration:input_type -> user.ConfirmationRequest
	13, // 20: user.UserService.IsUserAuthenticated:input_type -> user.AuthRequest
	13, // 21: user.UserService.IsApiTokenValid:input_type -> user.AuthRequest
	2,  // 22: user.UserService.GetQR2FA:input_type -> user.UserIdRequest
	3,  // 23: user.UserService.Enable2FA:input_type -> user.TFARequest
	3,  // 24: user.UserService.Verify2FA:input_type -> user.TFARequest
	2,  // 25: user.UserService.Disable2FA:input_type -> user.UserIdRequest
	15, // 26: user.UserService.UpdatePasswordRequest:input_type -> user.NewPasswordRequest
	17, // 27: user.UserService.GetAllUsersExperienceRequest:input_type -> user.ExperienceRequest
	19, // 28: user.UserService.PostExperienceRequest:input_type -> user.NewExperienceRequest
	21, // 29: user.UserService.DeleteExperienceRequest:input_type -> user.DeleteUsersExperienceRequest
	2,  // 30: user.UserService.IsUserPrivateRequest:input_type -> user.UserIdRequest
	23, // 31: user.UserService.AddUserSkill:input_type -> user.NewSkillRequest
	25, // 32: user.UserService.AddUserInterest:input_type -> user.NewInterestRequest
	27, // 33: user.UserService.RemoveSkill:input_type -> user.RemoveSkillRequest
	28, // 34: user.UserService.RemoveInterest:input_type -> user.RemoveInterestRequest
	2,  // 35: user.UserService.ApiTokenRequest:input_type -> user.UserIdRequest
	2,  // 36: user.UserService.ApiTokenCreateRequest:input_type -> user.UserIdRequest
	2,  // 37: user.UserService.ApiTokenRemoveRequest:input_type -> user.UserIdRequest
	5,  // 38: user.UserService.GetRequest:output_type -> user.GetResponse
	7,  // 39: user.UserService.GetAllRequest:output_type -> user.UsersResponse
	5,  // 40: user.UserService.PostRequest:output_type -> user.GetResponse
	5,  // 41: user.UserService.PostAdminRequest:output_type -> user.GetResponse
	5,  // 42: user.UserService.UpdateRequest:output_type -> user.GetResponse
	6,  // 43: user.UserService.DeleteRequest:output_type -> user.EmptyRequest
	7,  // 44: user.UserService.SearchUsersRequest:output_type -> user.UsersResponse
	11, // 45: user.UserService.LoginRequest:output_type -> user.LoginResponse
	32, // 46: user.UserService.ConfirmRegistration:output_type -> user.ConfirmationResponse
	14, // 47: user.UserService.IsUserAuthenticated:output_type -> user.AuthResponse
	2,  // 48: user.UserService.IsApiTokenValid:output_type -> user.UserIdRequest
	29, // 49: user.UserService.GetQR2FA:output_type -> user.TFAResponse
	6,  // 50: user.UserService.Enable2FA:output_type -> user.EmptyRequest
	11, // 51: user.UserService.Verify2FA:output_type -> user.LoginResponse
	6,  // 52: user.UserService.Disable2FA:output_type -> user.EmptyRequest
	5,  // 53: user.UserService.UpdatePasswordRequest:output_type -> user.GetResponse
	18, // 54: user.UserService.GetAllUsersExperienceRequest:output_type -> user.ExperienceResponse
	20, // 55: user.UserService.PostExperienceRequest:output_type -> user.NewExperienceResponse
	6,  // 56: user.UserService.DeleteExperienceRequest:output_type -> user.EmptyRequest
	22, // 57: user.UserService.IsUserPrivateRequest:output_type -> user.PrivateResponse
	6,  // 58: user.UserService.AddUserSkill:output_type -> user.EmptyRequest
	6,  // 59: user.UserService.AddUserInterest:output_type -> user.EmptyRequest
	6,  // 60: user.UserService.RemoveSkill:output_type -> user.EmptyRequest
	6,  // 61: user.UserService.RemoveInterest:output_type -> user.EmptyRequest
	30, // 62: user.UserService.ApiTokenRequest:output_type -> user.ApiTokenResponse
	30, // 63: user.UserService.ApiTokenCreateRequest:output_type -> user.ApiTokenResponse
	6,  // 64: user.UserService.ApiTokenRemoveRequest:output_type -> user.EmptyRequest
