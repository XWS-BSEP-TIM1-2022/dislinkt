...
var file_user_userService_proto_rawDesc = []byte{
	...
	0x61, 0x72, 0x63, 0x68, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x32, 0xa8, 0x05, 0x0a, 0x0b, 0x55, 0x73,
	...
	0x69, 0x61, 0x6c, 0x73, 0x42, 0x38, 0x5a, 0x36, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
...
var file_user_userService_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
...
var file_user_userService_proto_depIdxs = []int32{
	...
	2,  // 12: user.UserService.GetRequest:output_type -> user.GetResponse
	4,  // 13: user.UserService.GetAllRequest:output_type -> user.UsersResponse
	2,  // 14: user.UserService.PostRequest:output_type -> user.GetResponse
	2,  // 15: user.UserService.PostAdminRequest:output_type -> user.GetResponse
	2,  // 16: user.UserService.UpdateRequest:output_type -> user.GetResponse
	3,  // 17: user.UserService.DeleteRequest:output_type -> user.EmptyRequest
	4,  // 18: user.UserService.SearchUsersRequest:output_type -> user.UsersResponse
	8,  // 19: user.UserService.LoginRequest:output_type -> user.LoginResponse
